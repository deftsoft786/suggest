                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-sm-7 col-lg-6">
                            <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Select Course Type
...
@endif</li>
                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="{{url('admin/view_college_course')}}" method="post"  class="form-horizontal  login_validator" id="form_block_validator">
                                          {{ csrf_field() }}
                                     
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label for="url2" class="col-form-label">Select Course Type *</label>
                                                </div>
                                                <div class="col-lg-4">

                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-sm-7 col-lg-6">
                            <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Edit Category
...
@endif</li>
                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="{{url('admin/edit_category/'.$data->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal  login_validator" id="form_block_validator">
                                          {{ csrf_field() }}

                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-sm-7 col-lg-6">
                            <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Add Event
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-block m-t-35">
                                        <form  class ='dropzone' id ='image-upload' action="{{url('admin/add_events/'.$name->id)}}" method="post" enctype="multipart/form-data" >
                                          {{ csrf_field() }}
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="event_title" value="{{old('college_name')}}" class="form-control">
                                    </div>

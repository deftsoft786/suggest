...
<section>
  <div class="container">
    <div class="row exam" style="background:#fff; margin-top:98px">
            <h2 style="padding-left:20px; color:#004080; text-align:center">Indian Institute of Management, Ahmedabad, Vastrapur, Ahmedabad</h2>
      <div class="col-md-12">
          <center><img src="{{url('shiksha/assets/images/slider2.jpg')}}" style="height:400px"></center>
          
          
              <h5 style="color:#004080; font-weight:bold; text-align:center">Indian Institute of Management, Ahmedabad, Vastrapur, Ahmedabad</h5>
              <p style="color:#004080; text-align:center; font-weight:bold; padding-left:30px">Public/Government | Established 1961 </p>

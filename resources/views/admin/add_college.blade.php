                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-sm-7 col-lg-6">
                            <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Add College
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-block m-t-35">
                                        <form  class = 'dropzone' id = 'image-upload' action="{{url('admin/add_college')}}" method="post" enctype="multipart/form-data" >
                                          {{ csrf_field() }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" name="college_name" value="{{old('college_name')}}" class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div id="locationField" class="col-lg-4">
                                                    ...
                                                    <input onFocus="geolocate()" type="text" id="autocomplete" name="location" value="" class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div id="yearField" class="col-lg-4">
                                                   <select id="year" name="establishment" class="form-control">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="col-lg-4 text-lg-right">
                                                    ...
                                                    <label class="custom-control custom-checkbox">
                                                        ...
                                                        <input type="radio" name="type" value="1" class="custom-control-input" >
                                                    ...
                                                    <label class="custom-control custom-checkbox">
                                                        ...
                                                        <input type="radio" name="type" value="2" class="custom-control-input" >
                                         ...
                                         <div class="form-group row">
                                             <div class="col-lg-4 text-lg-right">
                                               ...
                                               @foreach($data as $value)
                                                    <label class="custom-control custom-checkbox">
                                                       <input type="checkbox" name="category[]" value="{{$value->id}}" class="custom-control-input" >
                                                        <span class="custom-control-indicator"> </span>
                                                        <span class="custom-control-description">{{$value->category_name}}</span>
                                                    </label>
                                                          @endforeach           
...
var till = 2020;
var options = "";
  options += "<option value=''> Select year of Establishment</option>";

                            ...
                            <div class="col-12 data_tables">
                                ...
                                <div class="card m-t-35">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-user"></i> Total Users Table
...
@foreach($data as $value)
                                    <tr>
                                         ...
                                         <td>@if(!empty($value->block_status == 1)) {{ 'Blocked' }} @else Unblocked @endif</td>
                                          <td class="action-icons text-center"><span> 
@if(empty($value->block_status == 1))
                                            <a onclick="return confirm('Are you sure you want to Block this user?')" style="text-decoration:none;" href="{{ url('admin/changed_block/'.$value->id) }}">  </span><i style="color:orange;" title="Block" class="fa fa-window-close fa-lg" aria-hidden="true"></i> </a> &nbsp
@else

                                            <a onclick="return confirm('Are you sure you want to unblock this user?')" style="text-decoration:none;" href="{{ url('admin/changed_unblock/'.$value->id) }}">  </span><i style="color:green;" title="Unblock" class="fa fa-check fa-lg" aria-hidden="true"></i></a>&nbsp

@endif
                                            <a onclick="return confirm('Are you sure you want to delete this User?');" href="{{url('admin/delete_user/'.$value->id)}}"><i  style="color:red;" title="Delete" class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>

                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-sm-7 col-lg-6">
                            <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Select Exam Type
...
@endif</li>
                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="{{url('admin/view_exam')}}" method="post"  class="form-horizontal  login_validator" id="form_block_validator">
                                          {{ csrf_field() }}
                                     
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label for="url2" class="col-form-label">Select Exam Type *</label>
                                                </div>
                                                <div class="col-lg-4">
                                                       ...
                                                       <option  value="MBA"> MBA  </option>
                                                          <option  value="Engineering"> Engineering  </option>
                                                             <option  value="LAW"> Law  </option>
                                                              ...
                                                              <option  value="Other"> Hospitality & Other  </option>
                                            ...
                                            <div class="form-actions form-group row">
                                                <div class="col-lg-4 push-lg-4">
                                                    <input type="submit" value="SELECT" class="btn btn-success">
                                                     <a class="btn btn-primary" href="{{url('admin/add_exam')}}"> </span> ADD NEW  </a>
